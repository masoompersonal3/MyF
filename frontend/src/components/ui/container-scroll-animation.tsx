...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full p-2 md:p-6 bg-zinc-900/20 backdrop-blur-md rounded-[30px] transition-all duration-500 hover:bg-[rgba(173,173,173,0.05)]"
    >
